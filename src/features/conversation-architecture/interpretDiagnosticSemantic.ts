/**
 * Phase 4 — diagnostic Semantic Interpreter (meaning only).
 *
 * Builds SemanticInterpretation from message + canonical snapshot.
 * Not production-authoritative. No city-name sentence catalogue:
 * places resolve from curated TLI data, current state entities, and
 * shape-valid captures under meaning frames.
 */
