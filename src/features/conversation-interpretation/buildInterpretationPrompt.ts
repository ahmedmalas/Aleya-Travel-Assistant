...
export function buildInterpretationPrompt(
  ...
  return [
    ...
    '- trip structure is ONE semantic class: one_way | return | multi_city. Multi-destination / multi-city declarations set tripStructure multi_city. An ordered list of two or more destination cities (list/sequence structure) sets tripStructure multi_city and fills destinationStops with EVERY city in order — never keep only the first city. destination mirrors the first stop.',
